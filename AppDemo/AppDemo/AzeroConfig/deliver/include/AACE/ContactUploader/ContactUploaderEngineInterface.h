    ...
    */
    enum class ContactUploaderStatus {
        ...
        */
        ...
        /**
         * Error while updating contact from Cloud.
         */
        UPDATE_CONTACTS_ERROR,

        /**
         * Error while querying contact from Cloud.
         */
        QUERY_CONTACTS_ERROR,

        /**
         * Error while delete contact from Cloud.
         */
        DELETE_CONTACTS_ERROR,

        /**
         * Error while clear contact from Cloud.
         */
    ...
    virtual bool onUpdateContact( const std::string& contact ) = 0;
    virtual std::string onQueryContact() = 0;
    virtual bool onDeleteContact( const std::string& contact ) = 0;
    virtual bool onClearContacts() = 0;
...
inline std::ostream& operator<<(std::ostream& stream, const ContactUploaderEngineInterface::ContactUploaderStatus& status) {
    switch (status) {
        ...
        case ContactUploaderEngineInterface::ContactUploaderStatus::UNKNOWN_ERROR:
            ...
            break;
        case ContactUploaderEngineInterface::ContactUploaderStatus::UPDATE_CONTACTS_ERROR:
            stream << "UPDATE_CONTACTS_ERROR";
            break;
        case ContactUploaderEngineInterface::ContactUploaderStatus::QUERY_CONTACTS_ERROR:
            stream << "QUERY_CONTACTS_ERROR";
            break;
        case ContactUploaderEngineInterface::ContactUploaderStatus::DELETE_CONTACTS_ERROR:
            stream << "DELETE_CONTACTS_ERROR";
            break;
        case ContactUploaderEngineInterface::ContactUploaderStatus::CLEAR_CONTACTS_ERROR:
            stream << "CLEAR_CONTACTS_ERROR";
            break;
    }
    return stream;
}
