...
public:
    ...
    void setEngineInterface( std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::TemplateRuntimeObserverInterface> templateRuntimeEngineInterface );

private:
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::TemplateRuntimeObserverInterface> m_templateRuntimeEngineInterface;
};
