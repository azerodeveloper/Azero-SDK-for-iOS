...
#ifndef ALEXA_CLIENT_SDK_AVSCOMMON_UTILS_INCLUDE_AVSCOMMON_UTILS_TIMING_TIMINGRECORD_H_
#define ALEXA_CLIENT_SDK_AVSCOMMON_UTILS_INCLUDE_AVSCOMMON_UTILS_TIMING_TIMINGRECORD_H_
...
public:
    ...
    std::chrono::steady_clock::time_point getStopTime() const;

    void dump();

    friend std::ostream & operator<<(std::ostream &stream, const TimingRecord& rd);
...
std::ostream & operator<<(std::ostream &stream, const TimingRecord& rd);
...
#endif  // ALEXA_CLIENT_SDK_AVSCOMMON_UTILS_INCLUDE_AVSCOMMON_UTILS_TIMING_TIMINGRECORD_H_
