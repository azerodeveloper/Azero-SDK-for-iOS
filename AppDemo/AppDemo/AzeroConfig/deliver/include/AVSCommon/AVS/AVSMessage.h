...
#include "AzeroAttributesHeader.h"
...
public:
     ...
     */
    AVSMessage(std::shared_ptr<AVSMessageHeader> avsMessageHeader, std::string payload, std::shared_ptr<AzeroAttributesHeader> azeroAttributes);
    ...
    std::string getazeroAttributesAsString() const;
...
private:
    ...
    /// fields for azeroAttributes
    std::shared_ptr<AzeroAttributesHeader> m_azeroAttributes;
};
