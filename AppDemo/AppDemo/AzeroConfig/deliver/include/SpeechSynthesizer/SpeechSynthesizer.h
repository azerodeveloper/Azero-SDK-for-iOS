...
#include "AzeroSpeechCacheManage.h"
...
public:
    ...
    void setAzeroSpeechCachePath(const std::string& rootPath);
...
private:
    ...
    public:
        ...
        /// The @c ifstream from which to read speech audio.
        std::shared_ptr<std::ifstream> localStream;
    ...
    std::shared_ptr<Azero::AzeroSpeechCacheManage> m_SpeechCacheManage = nullptr;
};
