...
- (void)setupUI{
    ...
    bgImageView.image = [UIImage imageNamed:@"LaunchScreen4"];
...
- (void)statusConnectOperationIsLogin{
    ...
    BaseNC *loginNav = [[BaseNC alloc] initWithRootViewController:[[AwemeListViewController alloc]init]];
...
//                AppDelegate *app = (AppDelegate *)[UIApplication sharedApplication].delegate;
                [UIApplication sharedApplication].keyWindow.rootViewController =[AwemeListViewController new] ;
