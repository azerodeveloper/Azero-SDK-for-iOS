...
{
    if (!_commentView) {
        _commentView = [[CommentToolBar alloc]initWithFrame:CGRectMake(0, kScreenHeight-49, WIDTH, 49)];
...
//    [self.rightBtn setImage:[UIImage imageNamed:@"评论详情_关闭页面"] forState:UIControlStateNormal];
    ...
    _detailTab = [[UITableView alloc]initWithFrame:CGRectMake(0, kStatusBarHeight, WIDTH, kScreenHeight - kStatusBarHeight - 49) style:UITableViewStylePlain];
