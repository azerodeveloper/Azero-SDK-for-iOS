...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.contentLabel.preferredMaxLayoutWidth = WIDTH - 2*kGAP;
...
-(void)setModel:(CommentInfoModel *)model
{
    ...
    UIColor *pressHighColor = kColorFromRGBA(57, 45, 53, 0.6);;
    ...
    CGSize maxSize = CGSizeMake(WIDTH - leftSpace - rightSpace, CGFLOAT_MAX);
...
-(void)layoutSubviews
{
    ...
    CGFloat leftSpace = k750AdaptationWidth(30) + kAvatar_Size + kGAP;
    CGFloat rightSpace = k750AdaptationWidth(50);
    CGFloat width = WIDTH - (leftSpace + rightSpace);
