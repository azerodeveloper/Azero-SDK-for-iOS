...
-(void)addTableView
{
    ...
    _commentTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, WIDTH,kScreenHeight) style:UITableViewStyleGrouped];
...
- (void)tableView:(UITableView *)tableView willDisplayHeaderView:(UIView *)view forSection:(NSInteger)section {
    if ([view isKindOfClass:[UITableViewHeaderFooterView class]]) {
        ((UITableViewHeaderFooterView *)view).backgroundView.backgroundColor = Color130A29;
    }
}
