...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _bgColorView.backgroundColor = kColorFromRGBA(57, 45, 53, 0.4);
        ...
        self.contentLabel.preferredMaxLayoutWidth = WIDTH- kGAP-kAvatar_Size - 2*kGAP;
...
-(void)setFrame:(CGRect)frame{
    ...
    frame.size.width = WIDTH - leftSpace - k750AdaptationWidth(30);
...
-(void)setModel:(CommentInfoModel *)model
{
    ...
    CGSize onelineSize = CGSizeMake(WIDTH - (kGAP + kAvatar_Size + k750AdaptationWidth(30) + k750AdaptationWidth(30) + k750AdaptationWidth(20)), CGFLOAT_MAX);
