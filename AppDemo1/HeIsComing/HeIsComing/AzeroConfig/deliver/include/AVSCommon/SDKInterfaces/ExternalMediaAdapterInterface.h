...
inline std::string SupportedPlaybackOperationToString(SupportedPlaybackOperation operation) {
    switch (operation) {
        ...
        case SupportedPlaybackOperation::EXIT:
            return "Exit";
        case SupportedPlaybackOperation::FULL_SCREEN:
            return "FullScreen";
        case SupportedPlaybackOperation::EXIT_FULL_SCREEN:
            return "ExitFullScreen";
        case SupportedPlaybackOperation::BACK:
            return "Back";
        case SupportedPlaybackOperation::NEXT_PAGE:
            return "NextPage";
        case SupportedPlaybackOperation::PREVIOUS_PAGE:
            return "PreviousPage";
        case SupportedPlaybackOperation::SHOW_PLAYLISTS:
            return "ShowPlaylists";
        case SupportedPlaybackOperation::HIDE_PLAYLISTS:
