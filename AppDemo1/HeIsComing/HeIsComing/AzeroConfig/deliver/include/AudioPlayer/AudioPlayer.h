...
public:
    ...
    void onButtonPressed(avsCommon::avs::PlaybackButton button);
    void onTogglePressed(avsCommon::avs::PlaybackToggle toggle, bool action);
...
private:
    ...
    /**
     * used for ingnore resume old music when play new audio to replay old one;
     * JIRA : AZMOBILE-396 (No stop directive before audioplayer play is root case).
     */
    bool m_isPlayCalled;
