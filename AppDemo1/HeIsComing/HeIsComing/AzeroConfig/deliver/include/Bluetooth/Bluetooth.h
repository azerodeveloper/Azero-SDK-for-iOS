...
public:
    ...
    static std::shared_ptr<Bluetooth> create(
        std::shared_ptr<avsCommon::sdkInterfaces::bluetooth::BluetoothFactoryInterface> externalEmpl,
    ...
    auto setDeviceManager(std::unique_ptr<avsCommon::sdkInterfaces::bluetooth::BluetoothDeviceManagerInterface> deviceManager)->void;
...
private:
    ...
    using BluetoothFactoryInterface = alexaClientSDK::avsCommon::sdkInterfaces::bluetooth::BluetoothFactoryInterface;
    bool handleFactoryCmd(BluetoothFactoryInterface::BluetoothCmd cmd);
    bool handleFactoryEvent(BluetoothFactoryInterface::BluetoothEvent evt);

    bool executeSetPoweredMode(bool powered);
    ...
    std::shared_ptr<avsCommon::sdkInterfaces::bluetooth::BluetoothFactoryInterface> m_externalEmpl;
