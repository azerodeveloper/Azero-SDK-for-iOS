...
public:
     ...
     * @return @c true if successfully queued, @c false when contact format is not valid, upload not started or for any internal error.
     */
    bool updateContact( const std::string& contact );

    /**
     * Notifies the Engine to query the contact info with keyword contactId.
     *
     * Engine on returning @c true shall notify the platform implementation about the query status of contacts
     * via @sa contactsUploaderStatusChanged.
     *
     * @return @c true on successful, @c false if upload is in progress or due to any internal error.
     */
    std::string queryContact();

    /**
     * Notifies the Engine to delete the contact info with keyword contactId.
     *
     * Engine on returning @c true shall notify the platform implementation about the deleting status of contacts
     * via @sa contactsUploaderStatusChanged.
     *
     * @return @c true on successful, @c false if upload is in progress or due to any internal error.
     */
    ...
    /**
     * Notifies the Engine to clear the contact info for the device.
     *
     * Engine on returning @c true shall notify the platform implementation about the clear status of contacts
     * via @sa contactsUploaderStatusChanged.
     *
     * @return @c true on successful, @c false if upload is in progress or due to any internal error.
     */
