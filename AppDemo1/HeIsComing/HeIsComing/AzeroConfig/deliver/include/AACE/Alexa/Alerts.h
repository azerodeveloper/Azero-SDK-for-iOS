...
public:
    ...
    /**
     * Notifies the Engine of a platform request to remove a alert, such as when a user presses a physical button and input alertToken.
    */
    void removeAlert(const std::string& alertToken);
