...
#include "PhoneCallAudioChannelEngineImpl.h"
...
private:
    ...
    std::shared_ptr<aace::engine::phoneCallController::PhoneCallAudioChannelEngineImpl> m_phoneAudioChannelInterface;
    std::shared_ptr<aace::engine::phoneCallController::PhoneCallAudioChannelEngineImpl> m_phoneRingtoneChannelInterface;
