...
public:
    ...
    std::string getMessageRequestStatus() override;
    bool ClearDirectiveProcessId() override;
    ...
    std::unique_ptr<alexaClientSDK::avsCommon::avs::AudioInputStream::Writer> m_audioInputWriter; //unique_ptr
