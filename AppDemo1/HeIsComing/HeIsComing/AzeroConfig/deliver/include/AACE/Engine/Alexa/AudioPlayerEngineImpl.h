...
public:
     ...
     */
    void onButtonPressed(alexaClientSDK::avsCommon::avs::PlaybackButton button) override;
     ...
     */
    void onTogglePressed(alexaClientSDK::avsCommon::avs::PlaybackToggle toggle, bool action) override;
