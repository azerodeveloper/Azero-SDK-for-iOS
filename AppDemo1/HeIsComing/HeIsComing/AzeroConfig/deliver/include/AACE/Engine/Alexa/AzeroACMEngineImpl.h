 ...
 * ACM or implied. See the License for the specific language governing
 * permissions and limitations under the License.
 */

#ifndef AACE_ENGINE_ALEXA_AZERO_ACMEngineImpl_ENGINE_IMPL_H
#define AACE_ENGINE_ALEXA_AZERO_ACMEngineImpl_ENGINE_IMPL_H
...
class AzeroACMEngineImpl :
    ...
    , public aace::alexa::AzeroACMEngineInterface
    , public std::enable_shared_from_this<AzeroACMEngineImpl>{

private:
    AzeroACMEngineImpl( std::shared_ptr<aace::alexa::AzeroACM> azeroACMPlatformInterface,
...
public:
    static std::shared_ptr<AzeroACMEngineImpl> create(
        std::shared_ptr<aace::alexa::AzeroACM> azeroACMPlatformInterface,
        std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::MessageSenderInterface> messageSender,
        std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::AVSConnectionManagerInterface> connectManager,
        std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::DirectiveSequencerInterface> directiveSequencer,
        std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::CapabilitiesDelegateInterface> capabilitiesDelegate,
    ...
    // AzeroACMPlatformInterface
    void handleDirective(const std::string& name, const std::string& jsonPayload);
...
private:
    ...
    std::shared_ptr<aace::alexa::AzeroACM> m_azeroACMPlatformInterface;

    // @name RequiresShutdown Functions
    /// @{
    void doShutdown() override;

    /// This is the worker thread for the @c AzeroACM CA.
...
#endif // AACE_ENGINE_ALEXA_AZERO_ACMEngineImpl_ENGINE_IMPL_H
