 ...
 */
- (CGSize)rollView:(WSLRollView *_Nonnull)rollView sizeForItemAtIndex:(NSInteger)index;
/**
 item的间隔 默认值0
 */
- (CGFloat)spaceOfItemInRollView:(WSLRollView *_Nonnull)rollView;
/**
...
/**
 自定义item样式
 */
- (WSLRollViewCell *_Nullable)rollView:(WSLRollView *)rollView cellForItemAtIndex:(NSInteger )index;
@end
