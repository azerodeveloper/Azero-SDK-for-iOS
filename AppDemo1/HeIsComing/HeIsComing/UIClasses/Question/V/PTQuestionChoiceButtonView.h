...
typedef enum : NSUInteger {
    ...
    ChoiceButtonStatusSelected, // 用户已选择选中
    ChoiceButtonStatusServerSelected, // 服务器回调选中

    ChoiceButtonStatusScore, // 评分
    ChoiceButtonStatusRandom, // 随机

    ChoiceButtonStatusError, // 用户错误
