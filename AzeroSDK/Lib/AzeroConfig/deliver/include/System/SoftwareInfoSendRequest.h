...
public:
    ...
    static std::shared_ptr<SoftwareInfoSendRequest> create(
        ...
        avsCommon::sdkInterfaces::softwareInfo::FirmwareVersion volumeconfig,
        avsCommon::sdkInterfaces::softwareInfo::typestring wifi_ssid,
        bool bluetooth_active,
        avsCommon::sdkInterfaces::softwareInfo::typestring device_id,
        avsCommon::sdkInterfaces::softwareInfo::typestring device_mac,
        avsCommon::sdkInterfaces::softwareInfo::typestring device_ip,
...
private:
    ...
    const avsCommon::sdkInterfaces::softwareInfo::FirmwareVersion m_volumeconfig;
    const avsCommon::sdkInterfaces::softwareInfo::typestring m_wifi_ssid;
    bool m_bluetooth_active;
    const avsCommon::sdkInterfaces::softwareInfo::typestring m_device_id;
    const avsCommon::sdkInterfaces::softwareInfo::typestring m_device_mac;
    const avsCommon::sdkInterfaces::softwareInfo::typestring m_device_ip;
