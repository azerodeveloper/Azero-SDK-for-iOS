...
private:
    ...
    avsCommon::sdkInterfaces::softwareInfo::FirmwareVersion m_volumeconfig;
    avsCommon::sdkInterfaces::softwareInfo::typestring m_wifi_ssid;
    bool m_bluetooth_active;
    avsCommon::sdkInterfaces::softwareInfo::typestring m_device_id;
    avsCommon::sdkInterfaces::softwareInfo::typestring m_device_mac;
    avsCommon::sdkInterfaces::softwareInfo::typestring m_device_ip;
