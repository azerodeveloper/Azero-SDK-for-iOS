...
public:
    ...
    /// The default Player Channel name.
    static constexpr const char* PLAYER_CHANNEL_NAME = "Player";

    /// The default Player Channel priority.
    static constexpr unsigned int PLAYER_CHANNEL_PRIORITY = 200;
