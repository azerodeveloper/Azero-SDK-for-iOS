...
public:
    ...
    virtual std::unique_ptr<AttachmentReader> createCacheReader(utils::sds::ReaderPolicy policy) = 0;
    /**
...
protected:
    ...
    std::atomic<bool> m_hasCreatedCacheReader;
};
