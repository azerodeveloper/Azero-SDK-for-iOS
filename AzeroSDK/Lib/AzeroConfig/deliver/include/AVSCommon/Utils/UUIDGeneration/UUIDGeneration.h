...
/**
 * Update UUID generator random seed.
 * If this function is not invoked, @c generateUUID will use the system random seed.
 */
void updateUUIDGeneratorRandomSeed(uint64_t seed);
