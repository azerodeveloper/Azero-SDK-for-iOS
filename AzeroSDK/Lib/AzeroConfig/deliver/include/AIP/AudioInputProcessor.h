...
public:
    ...
    /// @}
    std::string getMessageRequestStatus();
    ...
    /// add for interactmode in android/ios APP mode
...
private:
    ...
    avsCommon::sdkInterfaces::MessageRequestObserverInterface::Status m_status;
    bool m_requestCompelted;
