...
public:
    ...
    static std::unique_ptr<DefaultClient> create(
        ...
        avsCommon::sdkInterfaces::softwareInfo::FirmwareVersion volumeconfig =
            avsCommon::sdkInterfaces::softwareInfo::INVALID_FIRMWARE_VERSION,
        avsCommon::sdkInterfaces::softwareInfo::typestring wifi_ssid = "NULL",
        bool bluetooth_active = false,
        avsCommon::sdkInterfaces::softwareInfo::typestring device_id = "NULL",
        avsCommon::sdkInterfaces::softwareInfo::typestring device_mac = "NULL",
        avsCommon::sdkInterfaces::softwareInfo::typestring device_ip = "NULL",
