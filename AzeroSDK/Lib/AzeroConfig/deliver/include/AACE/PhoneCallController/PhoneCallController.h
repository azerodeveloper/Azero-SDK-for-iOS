...
// #include "/data/xiaomeng/azero_sdk/aac-sdk/modules/alexa/platform/include/AACE/Alexa/AudioChannel.h"//add by xm
#include "AACE/Alexa/AudioChannel.h"//add by xm
#include "AVSCommon/Utils/MediaPlayer/MediaPlayerInterface.h" //add by xm
...
class PhoneCallController : public aace::core::PlatformInterface{
                            // public aace::alexa::AudioChannel{ //modified by xm
protected:
     PhoneCallController() = default;
     PhoneCallController( std::shared_ptr<aace::alexa::MediaPlayer> ringtoneMediaPlayer,std::shared_ptr<aace::alexa::Speaker> ringtoneSpeaker,
                          std::shared_ptr<aace::alexa::MediaPlayer> audioMediaPlayer,std::shared_ptr<aace::alexa::Speaker> audioSpeaker );
private:
    // std::shared_ptr<aace::alexa::MediaPlayer> m_audioMediaPlayer;
    // std::shared_ptr<aace::alexa::Speaker> m_audioSpeaker;
    std::shared_ptr<aace::alexa::AudioChannel> m_phoneAudioChannel;
    std::shared_ptr<aace::alexa::AudioChannel> m_phoneRingtoneChannel;
public:
    auto getPhoneAudioChannel(void) -> std::shared_ptr<aace::alexa::AudioChannel>;
    auto getPhoneRingtoneChannel(void) -> std::shared_ptr<aace::alexa::AudioChannel>;
public:
    ...
    using CallKeyEvent = aace::phoneCallController::PhoneCallControllerEngineInterface::CallKeyEvent;
    /**
     * 
    ...
    void setPhoneAudioMediaPlayerInterface( std::shared_ptr<alexaClientSDK::avsCommon::utils::mediaPlayer::MediaPlayerInterface> phoneMediaPlayerInterface );
    void setPhoneRingtoneMediaPlayerInterface( std::shared_ptr<alexaClientSDK::avsCommon::utils::mediaPlayer::MediaPlayerInterface> phoneMediaPlayerInterface );

//private:
protected://modified by xm
    std::shared_ptr<PhoneCallControllerEngineInterface> m_phoneCallControllerEngineInterface;

    std::shared_ptr<alexaClientSDK::avsCommon::utils::mediaPlayer::MediaPlayerInterface> m_phoneAudioMediaPlayerInterface;
    std::shared_ptr<alexaClientSDK::avsCommon::utils::mediaPlayer::MediaPlayerInterface> m_phoneRingtoneMediaPlayerInterface;
