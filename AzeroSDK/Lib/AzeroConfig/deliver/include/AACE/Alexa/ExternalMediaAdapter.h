...
inline std::ostream& operator<<(std::ostream& stream, const ExternalMediaAdapter::PlayControlType& requestType) {
    switch (requestType) {
        ...
        case ExternalMediaAdapter::PlayControlType::UNFAVORITE:
            stream << "UNFAVORITE";
            break;
        case ExternalMediaAdapter::PlayControlType::EXIT:
            stream << "EXIT";
            break;
        case ExternalMediaAdapter::PlayControlType::FULL_SCREEN:
            stream << "FULL_SCREEN";
            break;
        case ExternalMediaAdapter::PlayControlType::EXIT_FULL_SCREEN:
            stream << "EXIT_FULL_SCREEN";
			break;
		case ExternalMediaAdapter::PlayControlType::BACK:
			stream << "BACK";
            break;
        case ExternalMediaAdapter::PlayControlType::NEXT_PAGE:
            stream << "NEXT_PAGE";
            break;
        case ExternalMediaAdapter::PlayControlType::PREVIOUS_PAGE:
            stream << "PREVIOUS_PAGE";
            break;
        case ExternalMediaAdapter::PlayControlType::SHOW_PLAYLISTS:
            stream << "SHOW_PLAYLISTS";
            break;
        case ExternalMediaAdapter::PlayControlType::HIDE_PLAYLISTS:
            stream << "HIDE_PLAYLISTS";
            break;
...
inline std::ostream& operator<<(std::ostream& stream, const ExternalMediaAdapter::SupportedPlaybackOperation& supportedPlaybackOperation) {
    switch (supportedPlaybackOperation) {
        ...
        case ExternalMediaAdapter::SupportedPlaybackOperation::ADJUST_SEEK:
            stream << "ADJUST_SEEK";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::EXIT:
            stream << "EXIT";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::FULL_SCREEN:
            stream << "FULL_SCREEN";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::EXIT_FULL_SCREEN:
            stream << "EXIT_FULL_SCREEN";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::BACK:
            stream << "BACK";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::NEXT_PAGE:
            stream << "NEXT_PAGE";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::PREVIOUS_PAGE:
            stream << "PREVIOUS_PAGE";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::SHOW_PLAYLISTS:
            stream << "SHOW_PLAYLISTS";
            break;
        case ExternalMediaAdapter::SupportedPlaybackOperation::HIDE_PLAYLISTS:
            stream << "HIDE_PLAYLISTS";
            break;
    }
    return stream;
