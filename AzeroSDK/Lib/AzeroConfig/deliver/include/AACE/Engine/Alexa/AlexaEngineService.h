...
#include <System/AzeroSystemInfoHandler.h>
...
#include "AVSCommon/SDKInterfaces/AzeroGlobalInterface.h"
...
#include "AzeroExpressEngineImpl.h"
#include "AzeroACMEngineImpl.h"
#include "AzeroFileUploaderEngineImpl.h"
...
#ifdef ENABLE_BLUEZ_BLUETOOTH
#include <Bluetooth/SQLiteBluetoothStorage.h>
#include "BluetoothEngineImpl.h"
#endif

#include "AzeroBluetoothEngineImpl.h"
...
public:
    ...
    // add for android APP InteractMode settting;
    // bool setInteractMode( int mode ) override;
...
private:
    ...
    void updateUUIDGeneratorRandomSeed();
    ...
    bool registerPlatformInterfaceType( std::shared_ptr<aace::alexa::AzeroExpress> azeroExpress );
    bool registerPlatformInterfaceType( std::shared_ptr<aace::alexa::AzeroACM> azeroACM );
    bool registerPlatformInterfaceType( std::shared_ptr<aace::alexa::AzeroFileUploader> azeroFileUploader );

    #ifdef ENABLE_BLUEZ_BLUETOOTH
    bool registerPlatformInterfaceType( std::shared_ptr<aace::alexa::Bluetooth> bluetooth );
    #endif
    bool registerPlatformInterfaceType( std::shared_ptr<aace::alexa::AzeroBluetooth> azeroBluetooth );
...
private:
    ...
    std::shared_ptr<alexaClientSDK::capabilityAgents::system::AzeroSystemInfoHandler> m_azeroSystemInfoHandler;
    ...
    std::string m_endpoint = "https://fat-azero.soundai.cn";
    // "https://api.amazonalexa.com";
    std::string m_capabilitiesEndpoint = "https://fat-azero.soundai.cn";
    std::string m_avsGateway;
    std::string m_lwaEndpoint;
    
    alexaClientSDK::avsCommon::sdkInterfaces::softwareInfo::FirmwareVersion m_volumeconfig = 100;
    alexaClientSDK::avsCommon::sdkInterfaces::softwareInfo::FirmwareVersion m_firmwareVersion = 001;
    alexaClientSDK::avsCommon::sdkInterfaces::softwareInfo::typestring m_wifi_ssid = "no_WIFI_SSID";
    bool m_bluetooth_active = false;
    alexaClientSDK::avsCommon::sdkInterfaces::softwareInfo::typestring m_device_id = "no_123456";
    alexaClientSDK::avsCommon::sdkInterfaces::softwareInfo::typestring m_mac = "12:34:56:78";
    alexaClientSDK::avsCommon::sdkInterfaces::softwareInfo::typestring m_ip = "192.168.1.123";
    ...
    std::shared_ptr<aace::engine::alexa::AzeroExpressEngineImpl> m_azeroExpressEngineImpl;
    std::shared_ptr<aace::engine::alexa::AzeroACMEngineImpl> m_azeroACMEngineImpl;
    std::shared_ptr<aace::engine::alexa::AzeroFileUploaderEngineImpl> m_azeroFileUploaderEngineImpl;
    #ifdef ENABLE_BLUEZ_BLUETOOTH
    std::shared_ptr<alexaClientSDK::capabilityAgents::bluetooth::BluetoothStorageInterface> m_bluetoothStorageInterface;
    std::shared_ptr<aace::engine::alexa::BluetoothEngineImpl> m_bluetoothEngineImpl;
    #endif
    std::shared_ptr<aace::engine::alexa::AzeroBluetoothEngineImpl> m_azeroBluetoothEngineImpl;
...
public:
    ...
    void setLocalHandlerForAudioPlayer(std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::PlaybackHandlerInterface> handler) override;
...
private:
    ...
    std::condition_variable m_setDelegateCV;
    std::mutex m_setDelegateCVMutex;
};
