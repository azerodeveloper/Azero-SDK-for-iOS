...
public:
    static std::shared_ptr<FileSink> create( const std::string& id, const std::string& path, const std::string& prefix = "aace", uint32_t maxSize = 5242880, uint32_t maxFiles = 3, bool append = true );
