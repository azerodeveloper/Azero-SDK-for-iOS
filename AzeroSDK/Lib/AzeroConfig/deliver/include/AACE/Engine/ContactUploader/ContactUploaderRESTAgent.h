...
public:
    ...
    bool updateContactViaId( const std::string& jsonContact );
    HTTPResponse queryContact();
    bool deleteContactViaId( const std::string& contactId );
    bool clearContacts();
...
private:
    ...
    std::string buildContactsJson( const std::string& contactId );
