...
public:
    ...
    bool onUpdateContact( const std::string& contact ) override;
    std::string onQueryContact() override;
    bool onDeleteContact( const std::string& contactId ) override;
    bool onClearContacts() override;
